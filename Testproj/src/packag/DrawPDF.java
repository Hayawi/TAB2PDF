...
public class DrawPDF {
	...
	public static void main(String[] args) throws DocumentException, IOException {
		Tablature tab = new Tablature("C:/Users/JH/Documents/CSE2311/Testproj/src/packag/moonlightsonata.txt", "C:/New folder/test2.pdf");
		tab.draw();
	...
	public static void processMeasure(Measure measure) throws DocumentException, IOException {
		...
		for (ArrayList<String> tokens : measure.getTokens()) {
			if (firstLine) {	
				barLength = measure.getLength() * spacing; // get the length of the measure
	...
	public static void draw(ArrayList<String> tokens, boolean firstLineOfMeasure, PdfContentByte cb) throws DocumentException, IOException {
	...
	/*		if (hold && Pattern.matches("[0-9]+", s)) {
				drawHold(s, previousNoteX, previousNoteY, horizontalShift, pageLocationY);
				System.out.println(previousNoteX + " " + previousNoteY);
				System.out.println(horizontalShift + " " + pageLocationY);
				System.out.println(previousNote + " " + s);
				hold = false;
			}  */
	...
	public static void drawHold(String letter, float xStart, float yStart, float xEnd, float yEnd) {
